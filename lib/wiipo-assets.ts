export const wiipoAssets = {
  ...
  assinatura: {
    ...
    loaf: "/wiipo/assinatura/loaf.png",
    loafSide: "/wiipo/assinatura/loaf-side.png",
    perch: "/wiipo/assinatura/perch.png",
  },
} as const;
...
export const assinaturaFrames = [
  ...
  {
    src: wiipoAssets.assinatura.loaf,
    id: "loaf",
    title: "loaf",
    note: "Deitado no topo do botão, como o gato do Skool.",
  },
  {
    src: wiipoAssets.assinatura.loafSide,
    id: "loaf-side",
    title: "loaf side",
    note: "Loaf de lado, ao longo da borda.",
  },
  {
    src: wiipoAssets.assinatura.perch,
    id: "perch",
    title: "perch",
    note: "Sentado no canto direito do botão.",
  },
] as const;
